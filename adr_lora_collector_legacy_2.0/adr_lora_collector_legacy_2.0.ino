...
void setup()
{
  ...
  attachInterrupt(digitalPinToInterrupt(flowmeter[4].getPin()), ticker4, FALLING);
...
void loop()
{
  ...
  if ((millis() - lastCount) > (FCOUNT_INTVAL * 1000))
  {
    ...
    detachInterrupt(digitalPinToInterrupt(flowmeter[4].getPin()));
